...
@Database(entities = [DishModel::class, CartModel::class, RateModel::class, DishRateRemoteKeys::class, CartItem::class, HistoryCartModel::class], version = 3, exportSchema = false)
