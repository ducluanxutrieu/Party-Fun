...
class DishModel {
  ...
  factory DishModel.fromJson(Map<String, dynamic> json) => DishModel(
        ...
        quantity: 1,
        image: List<String>.from(json["image"].map((x) => x.replaceAll('192.168.1.8', '172.20.10.45'))),
        featureImage: (json["feature_image"] as String).replaceAll('192.168.1.8', '172.20.10.45'),
